    ...
    const handleSubmit = async () => {
        ...
        const payload = {
            ...
            worker_agent_models: models.map(model => ({
                ...
                endpoint: model.endpoint || "http://localhost:11434/v1",
                ...
                <>
                    ...
                    {models.map((model, index) => (
                        <div key={index} style={styles.modelContainer}>
                            ...
                            <input type="text" style={styles.input} placeholder="Default: http://localhost:11434/v1" value={model.endpoint} onChange={(e) => handleModelChange(index, "endpoint", e.target.value)} />
